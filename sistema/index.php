...
$linhas = @count($res);
if ($linhas == 0) {
	$pdo->query("INSERT INTO usuarios SET nome = 'Administrador', email = '$email_super_adm', senha = '', senha_crip = '$senha_crip', nivel = 'Bispo', ativo = 'Sim', foto = 'sem-foto.jpg', igreja = 0");
}
...
<head>
		...
		<link rel="icon" href="img/logo-icone.png" type="image/x-icon"/>
						...
						<div class="col-xl-5 col-lg-6 col-md-8 col-sm-8 col-xs-10 card-sigin-main mx-auto my-auto py-4 justify-content-center">
							<div class="card-sigin">
								 ...
								 <div class="main-card-signin d-md-flex">
									 <div class="wd-100p"><div class="d-flex mb-4 justify-content-center"><a href="index.php"><img src="img/logo-icone.png" class="sign-favicon" alt="logo" width="130px"></a></div>
										 <div class="">
		...
		?>		
															   ...
															   <form method="post" action="autenticar.php">
																   <div class="form-group">
																	   <label>Usuário</label> 
																	   <input class="form-control" name="usuario" placeholder="Email ou CPF" id="usuario" type="text" required value="">
																   </div>
																   <div class="form-group">
