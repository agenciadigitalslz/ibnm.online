						...
						<div class="col-md-4">
							<div class="mb-3">
								...
								<select class="form-select sel2" id="pastor" name="pastor" style="width:100%;">
									<option value="0">Selecionar um Pastor</option>
									<?php 
					...
					<div class="row">
						...
						<div class="row">
							...
							<div class="row">
								...
								<label for="exampleFormControlInput1" class="">Descrição da Igreja <small>(Texto apresentado no site) (Máximo 3000 Caracteres)</small></label>
								<textarea class="form-control textarea" id="descricao" name="descricao" maxlength="3000"></textarea>
							</div>
