...
//validacao hora
$query = $pdo->query("SELECT * from $tabela where data = '$data' and hora = '$hora' and usuario = '$usuario_tarefa' and igreja = '$igreja'");
...
if($id == ""){
$query = $pdo->prepare("INSERT INTO $tabela SET usuario = '$usuario_tarefa', usuario_lanc = '$id_usuario', data = '$data', hora = '$hora', hora_mensagem = '$hora_alerta', descricao = :descricao, status = 'Agendada', prioridade = '$prioridade', igreja = '$igreja'");
	
}else{
$query = $pdo->prepare("UPDATE $tabela SET data = '$data', hora = '$hora', hora_mensagem = '$hora_alerta', descricao = :descricao, prioridade = '$prioridade', igreja = '$igreja' where id = '$id'");
}
