...
<td>
	<big><a class="btn btn-info btn-sm" href="#" onclick="editar('{$id}','{$nome}','{$email}','{$telefone}','{$nivel}','{$endereco}')" title="Editar Dados"><i class="fa fa-edit "></i></a></big>
...
<big><a class="btn btn-primary btn-sm" href="#" onclick="mostrar('{$nome}','{$email}','{$telefone}','{$ativo}','{$nivel}','{$endereco}')" title="Mostrar Dados"><i class="fa fa-info-circle "></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, email, telefone, nivel, endereco){
		$('#mensagem').text('');
	...
	function mostrar(nome, email, telefone, ativo, nivel, endereco){
