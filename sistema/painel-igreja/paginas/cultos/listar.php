...
<td>
	<big><a class="btn btn-info btn-sm" href="#" onclick="editar('{$id}','{$nome}','{$dia}','{$hora}','{$descricao}','{$obs}')" title="Editar Dados"><i class="fa fa-edit "></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, dia, hora, descricao, obs){
		$('#mensagem').text('');
