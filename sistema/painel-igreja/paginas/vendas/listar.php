...
if($linhas > 0){
	...
	for($i=0; $i<$linhas; $i++){
		...
		<td>
		<big><a class="btn btn-info btn-sm" href="#" onclick="editar('{$id}','{$descricao}','{$valor}','{$data}','{$usuario}')" title="Editar Dados"><i class="fa fa-edit "></i></a></big>
...
<script type="text/javascript">
	function editar(id, descricao, valor, data, usuario){
		$('#mensagem').text('');
