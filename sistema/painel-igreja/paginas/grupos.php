					...
					<div class="row">
						...
						<div class="col-md-4">
							<label >Secretário</label>
									<select class="form-control sel2" id="secretario" name="secretario" style="width:100%;">
							...
							<div class="tile">
								<div class="table-responsive">
									<table id="" class="text-left table table-bordered">
										...
										<tr>
											<td class="bg-warning alert-warning w_150">Horário</td>
									...
									<tr>
										<td class="bg-warning alert-warning w_150">Regente</td>
										<td><span id="regente_dados"></span></td>
									</tr>
									...
									<tr>
										<td class="bg-warning alert-warning w_150">Tesoureiro</td>
										<td><span id="tesoureiro_dados"></span></td>
									</tr>
