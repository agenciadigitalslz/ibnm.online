			...
			<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-12 mb-2">							
								...
								<textarea maxlength="500" class="form-control" id="versiculo" name="versiculo"></textarea>							
						</div>


							<div class="col-md-12 mb-2">							
								<label>Capítulo</label>
								<input type="text" class="form-control" id="capitulo" name="capitulo" placeholder="Ex: Josue 1:9">							
						</div>
