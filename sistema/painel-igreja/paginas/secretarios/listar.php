...
<td>
	<a class="btn btn-primary btn-sm" href="#" onclick="editar('{$id}','{$nome}','{$email}','{$telefone}','{$endereco}','{$cpf}','{$nome_ig}','{$foto}')" title="Editar Dados"><i class="fa fa-edit"></i></a>
...
<a class="btn btn-primary btn-sm" href="#" onclick="mostrar('{$nome}','{$email}','{$telefone}','{$endereco}','{$cpf}', '{$nome_ig}','{$foto}')" title="Mostrar Dados"><i class="fa fa-info-circle "></i></a>
...
<script type="text/javascript">
	function editar(id, nome, email, telefone, endereco, cpf, nome_ig, foto){
		$('#mensagem').text('');
	...
	function mostrar(nome, email, telefone, endereco, cpf, igreja, foto){
