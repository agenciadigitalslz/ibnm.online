...
<div class="justify-content-between">
 ...
 <a style="margin-bottom: 10px; margin-top: 5px" class="btn ripple btn-primary text-white" onclick="inserir()" type="button"><i class="fe fe-plus me-2"></i>Adicionar</a>


 <div style="display: inline-block; position:absolute; right:10px; margin-bottom: 10px">
            <select name="usuario_lanc" id="filtro_usuario_lanc" class="form-select" style="display:inline-block; width:auto; height:35px; font-size:13px; margin-right:8px">
...
.fin-cards .card{flex:1 1 180px;min-width:160px;max-width:calc(33.33% - 10px);height:auto !important;width:auto !important}
.fin-cards .card .card-body h4{font-size:1.25rem;word-break:break-word;overflow-wrap:anywhere;margin:0}
@media(max-width:1200px){.fin-cards .card .card-body h4{font-size:1.15rem}}
@media(max-width:992px){.fin-cards .card{max-width:calc(50% - 10px)}.fin-cards .card .card-body h4{font-size:1.05rem}}
@media(max-width:576px){.fin-cards .card{max-width:100%}.fin-cards .card .card-body h4{font-size:1rem}}
.fin-cards .card .card-header{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.fin-cards .card .card-body h4 span{display:inline-block;max-width:100%;}
/* Diminui número quando muitos dígitos */
.fin-cards .card .card-body h4.auto-shrink{font-size:1.1rem}
</style>
<div class="card-group fin-cards" style="margin-bottom: -30px">
     ...
     <div class="card text-center mb-5" style="width: 100%; margin-right: 10px; border-radius: 10px; height:110px">
      ...
      <div class="card text-center mb-5" style="width: 100%; margin-right: 10px; border-radius: 10px; height:110px">
    	<a href="#" onclick="$('#tipo_data_filtro').val('Todas'); $('#pago').val(''); buscar();">
          ...
          <div class="card text-center mb-5" style="width: 100%; margin-right: 10px; border-radius: 10px; height:110px">
		<a href="#" onclick=" $('#tipo_data_filtro').val('Pendentes'); $('#pago').val('Não'); buscar();">
			<div class="card-header border-light text-white" style="background: #b31d33;">
	             Pendentes
	            <i class="fa fa-external-link pull-right"></i>
	        </div>
	        <div class="card-body">
	        	<p class="card-text" style="margin-top:-15px;">
	        		<h4><span style="color: #b31d33" id="total_pendent">R$ 0,0</span></h4>
	        	</p>
	        </div>
        </a>
    </div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-5">							
							<label>Membro</label>
								<select name="membro" id="membro" class="sel2" style="width:100%; height:35px; ">
								<option value="0">Selecione um Membro</option>
								<?php 
								if($mostrar_registros == 'Não'){
									$query = $pdo->query("SELECT * from membros where usuario = '$id_usuario' and igreja = '$id_igreja' order by id asc");
								}else{
					...
					<input type="hidden" id="id_igreja" name="igreja" value="<?php echo $id_igreja ?>">
							...
							<div class="tile">
								<div class="table-responsive">
									<table id="" class="text-left table table-bordered">
										<tr>
											<td class="bg-warning alert-warning">Membro</td>
											<td><span id="membro_dados"></span></td>
										</tr>
