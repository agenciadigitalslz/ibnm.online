...
for($i=1; $i <= $qtd_parcelas; $i++){
	...
	$pdo->query("INSERT INTO $tabela set descricao = '$nova_descricao', fornecedor = '$fornecedor', valor = '$novo_valor', usuario_lanc = '$id_usuario', data_lanc = curDate(), vencimento = '$novo_vencimento', frequencia = '$frequencia', forma_pgto = '$saida', arquivo = '$arquivo', pago = 'Não', referencia = '$referencia', id_ref = '$id_ref', subtotal = '$novo_valor', igreja = '$igreja'");
