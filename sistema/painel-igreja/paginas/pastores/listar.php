...
<td>
	<a class="btn btn-info btn-sm" href="#" onclick="editar('{$id}','{$nome}','{$email}','{$telefone}','{$endereco}','{$cpf}','{$data_nasc}','{$igreja}','{$foto}','{$obs}')" title="Editar Dados"><i class="fa fa-edit"></i></a>
...
<a class="btn btn-primary btn-sm" href="#" onclick="mostrar('{$nome}','{$email}','{$telefone}','{$endereco}','{$cpf}','{$data_nascF}','{$nome_ig}','{$foto}','{$obs}')" title="Mostrar Dados"><i class="fa fa-info-circle"></i></a>
...
<script type="text/javascript">
	function editar(id, nome, email, telefone, endereco, cpf, data_nasc, igreja, foto, obs){
		$('#mensagem').text('');
	...
	function mostrar(nome, email, telefone, endereco, cpf, data_nasc, igreja, foto, obs){
