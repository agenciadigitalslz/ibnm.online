...
if ($id == "") {
	$query = $pdo->prepare("INSERT INTO $tabela SET titulo_pergunta = :titulo_pergunta, descricao_pergunta = :descricao_pergunta, posicao_pergunta = :posicao_pergunta, empresa = '$id_igreja'");
