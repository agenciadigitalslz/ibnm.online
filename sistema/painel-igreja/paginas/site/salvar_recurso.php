...
if ($id == "") {
	$query = $pdo->prepare("INSERT INTO $tabela SET titulo_recurso = :titulo_recurso, descricao_recurso = :descricao_recurso, posicao_recurso = :posicao_recurso, icone_recurso = :icone_recurso, empresa = '$id_igreja'");
