...
if($ext == 'png' or $ext == 'jpg' or $ext == 'JPG' or $ext == 'jpeg' or $ext == 'gif' or $ext == 'pdf' or $ext == 'rar' or $ext == 'zip' or $ext == 'docx' or $ext == 'doc' or $ext == 'webp'){ 
...
if($id == "" || $id == 0){
	$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, descricao = :descricao, data = '$data', arquivo = '$arquivo', usuario_cad = '$id_usuario', igreja = '$igreja'");
