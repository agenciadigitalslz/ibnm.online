...
if($igreja > 0){
	$sql_igreja = " where igreja = '$igreja' ";
}else{
	$sql_igreja = " ";
}
...
if($filtro_lancamento == 'membro'){		
	$filtro_lancamentoF = 'Recebimentos Membros';
	$filtro_tabela = 'membros';		
}
...
$query9 = $pdo->query("SELECT * from $filtro_tabela $sql_igreja order by nome asc");
...
<td style="width:25%">
	...
	<td style="width:20%"><?php echo $nome_igreja ?></td>
...
<td style="width:15%"><?php echo $tel_pessoa ?></td>
    </tr>
