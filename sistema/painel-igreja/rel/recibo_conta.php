...
$query2 = $pdo->query("SELECT * FROM membros where id = '$pessoa'");
...
<div class="receipt-main">
							...
							<img class="imagem" src="<?php echo $url_sistema ?>img/igrejas/<?php echo $imagem_igreja ?>" width="200px" height="60px">
  ...
  <br>
   ...
   <div align="center">
    <?php echo mb_strtoupper($nome_sistema) ?> 
     - <?php echo $telefone_igreja_sistema ?>
  </div>
