...
<table class="printer-ticket">
	...
	<tr style="font-size: 10px">
		<th colspan="3">
			<?php echo $endereco_igreja_sistema ?> <br />
			Contato: <?php echo $telefone_igreja_sistema ?>  <?php if($cnpj_sistema != ""){ ?> / CNPJ <?php echo  $cnpj_sistema  ?><?php } ?>
		</th>
	</tr>

	<tr >
		<th colspan="3">Membro <?php echo $nome_membro ?> Tel: <?php echo $tel_membro ?>			
