$(function () {
	...
	// DataTables: evitar erro de reinicialização em recargas via AJAX
	if (window.jQuery && $.fn && $.fn.dataTable && $.fn.dataTable.defaults) {
		$.extend(true, $.fn.dataTable.defaults, { destroy: true });
	}
