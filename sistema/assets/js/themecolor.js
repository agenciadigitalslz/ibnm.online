...
function names() {
    ...
    if(document.querySelector('#statistics1') !== null && typeof statistics1 === 'function'){
        statistics1();
    }
    
    if(document.querySelector('#Viewers') !== null && typeof viewers === 'function'){
        viewers();
    }

    if(document.querySelector('.chart-circle') !== null && typeof chartCircle === 'function'){
        chartCircle();
    }    

    // desativado statistics2 (Growth)
    // if(document.querySelector('#statistics2') !== null && typeof statistics2 === 'function'){
    //     statistics2();
    // }
    
    if(document.querySelector('#budget') !== null && typeof budget === 'function'){
        budget();
    }
    
    if(document.querySelector('#Viewers1') !== null && typeof viewers1 === 'function'){
        viewers1();
    }   

    if(document.querySelector('#statistics3') !== null && typeof statistics3 === 'function'){
        statistics3();
    }
    
    if(document.querySelector('#Viewers2') !== null && typeof viewers2 === 'function'){
        viewers2();
    }
