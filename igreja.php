...
<body class="font-poppins bg-gradient-to-br from-primary-dark to-primary text-white min-h-screen overflow-x-hidden">
  <div class="py-12 px-4 sm:px-6 lg:px-8">
    <div class="container mx-auto">
      ...
      <?php if($botao1 != "" || $botao2 != "" || $botao3 != ""){ ?>
        <div class="flex flex-col sm:flex-row justify-center gap-4 mb-6">
          <?php if($botao1 != ""){ ?>
            <a href="#area_sobre" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-lg text-white bg-customGreen hover:bg-green-700 focus:outline-none animate-pulse-green transition-all duration-300">
          ...
          <?php } ?>
          <?php if($botao3 != ""){ ?>
           <a href="sistema" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-lg text-white bg-customAzul hover:bg-blue-700 focus:outline-none animate-pulse-blue transition-all duration-300">
   ...
   <?php 
   $query = $pdo->prepare("SELECT * FROM eventos where igreja = '$id_igreja' and ativo = 'Sim' order by id desc limit 10");
...
<div id="carousel" class="relative w-full h-64 sm:h-96 overflow-hidden rounded-lg ocultar_web">
  ...
  <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
    <button class="carousel-bullet w-3 h-3 rounded-full bg-white/50 hover:bg-white" data-index="0"></button>
    <button class="carousel-bullet w-3 h-3 rounded-full bg-white/50 hover:bg-white" data-index="1"></button>
    <button class="carousel-bullet w-3 h-3 rounded-full bg-white/50 hover:bg-white" data-index="2"></button>
...
<?php } ?>
 ...
 <!-- Botão "Ver Mais Produtos" -->
  <div class="text-center mt-10">
    <a href="eventos.php" class="inline-flex items-center justify-center px-8 py-3 border border-accent/30 text-base font-medium rounded-xl shadow-lg text-white hover:bg-accent hover:text-primary-dark focus:outline-none transition-all duration-300 group">
      <i class="fas fa-th-large mr-2 group-hover:animate-pulse"></i> Ver Todos os Eventos
...
<section class="bg-white py-10 px-4 md:px-10" id="area_sobre">
  ...
  <iframe class="rounded-xl shadow-lg w-full h-full"
    ...
    <!-- Texto + Botões -->
    <div>
      <h2 class="text-2xl font-bold text-primary mb-4">Sobre Nossa Igreja</h2>
      <p class="text-gray-700 mb-6">
        <?php echo $descricao_igreja ?>
      </p>
      <div class="flex space-x-4">
        <?php if($instagram != ""){ ?>
        <a href="<?php echo $instagram ?>" target="_blank" class="bg-pink-500 text-white p-3 rounded-full hover:bg-pink-600 transition-all flex items-center justify-center w-10 h-10 md:w-auto md:h-auto md:px-4 md:py-2 md:rounded-lg">
          <i class="fab fa-instagram text-lg md:mr-2"></i><span class="hidden md:inline">Instagram</span>
        </a>
         <?php } ?>

         <?php if($facebook != ""){ ?>
        <a href="<?php echo $facebook ?>" target="_blank" class="bg-blue-600 text-white p-3 rounded-full hover:bg-blue-700 transition-all flex items-center justify-center w-10 h-10 md:w-auto md:h-auto md:px-4 md:py-2 md:rounded-lg">
          <i class="fab fa-facebook-f text-lg md:mr-2"></i><span class="hidden md:inline">Facebook</span>
        </a>
        <?php } ?>

        <?php if($youtube != ""){ ?>
        <a href="<?php echo $youtube ?>" target="_blank" class="bg-red-600 text-white p-3 rounded-full hover:bg-red-700 transition-all flex items-center justify-center w-10 h-10 md:w-auto md:h-auto md:px-4 md:py-2 md:rounded-lg">
          <i class="fab fa-youtube text-lg md:mr-2"></i><span class="hidden md:inline">YouTube</span>
        </a>
      <?php } ?>
      </div>
    </div>
...
<a title="Ir para o whatsapp" target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo @$telefone_igrejaF ?>"><img src="<?php echo $url_sistema ?>img/logo_whats.png" width="50px" style="position:fixed; bottom:20px; right:20px; z-index: 100"></a>
